...
if (isset($_POST["btnThem"])) {
    ...
    $qr = "INSERT INTO tin 
        VALUES('NULL', '$TieuDe', '$TieuDe_KhongDau', '$TomTat', '$urlHinh', '$Ngay', '$idUser', '$Content', '$idTL', '$idLT', '$SoLanXem', '$TinNoiBat', '$AnHien')";
...
<body>
    ...
    <table border="1" cellpadding="10" cellspacing="0" style="width: 800px;">
        ...
        <tr>
            <td></td>            
            <td>
                <input type="button" value="Thêm" id="btnThem" name="btnThem">
            </td>
        </tr>
    </table>
